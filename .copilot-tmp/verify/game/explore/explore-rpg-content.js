export const EXPLORE_ELEMENT_COLORS = {
    force: 0x9b6a3f,
    thermal: 0xff5c3b,
    light: 0xffd85a,
    electric: 0x4aa8ff,
...
export const EXPLORE_ELEMENT_LABELS = {
    force: "力",
    thermal: "热",
    light: "光",
    electric: "电",
...
export const EXPLORE_PLAYER_ELEMENTS = ["force", "thermal", "light", "electric", "sound"];
export const DEFAULT_EXPLORE_BOSSES = [
    {
        id: "ai-atlas",
        name: "重构者 Atlas",
...
export function getDefaultExploreBoss(id) {
