...
import { getAvailableGachaPools, getGachaPoolDisplayModel, performGachaDraw, resolveSelectedGachaPoolId, } from "../economy/gacha";
export class GachaPanelPresenter {
    constructor(els, ports) {
    ...
    draw(requestedCount) {
        ...
        this.ports.scheduleReveal(() => {
            ...
            if (drawResult.unlockedNow) {
                ...
                this.ports.toast(`${pool.name}\uff1aS \u7ea7\u5e72\u5458\u5df2\u89e3\u9501\uff0c\u53ef\u5728\u5854\u9632\u5730\u56fe\u90e8\u7f72`);
            }
