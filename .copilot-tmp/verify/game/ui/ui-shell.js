export function renderGameUiShell(app, requiredElement) {
    app.innerHTML = `
      <div class="game-root">
    ...
    return {
        ...
        gameGeoMappingToggle: requiredElement("#gameGeoMappingToggle"),
        topGeoMappingToggle: requiredElement("#topGeoMappingToggle"),
        ...
        activeSkillButton: requiredElement("#activeSkillButton"),
        ...
        gachaStageImgElement: requiredElement("#gachaStageImg"),
        ...
        defenseDifficultyHome: requiredElement("#defenseDifficultyHome"),
        defenseDifficultyHomeHint: requiredElement("#defenseDifficultyHomeHint"),
        defenseDifficultyPause: requiredElement("#defenseDifficultyPause"),
