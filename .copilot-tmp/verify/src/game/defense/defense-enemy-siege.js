...
function damageDefenseBuilding(building, damage, elapsed, onDemolish) {
    const reductionFactor = (building.damageReductionUntil ?? 0) > elapsed ? building.damageReductionFactor ?? 1 : 1;
...
export function applyEnemySiegeAgainstBuildings(enemy, buildings, dt, elapsed, onDemolish, spawnSiegeStrikeFx) {
