/**
 * scripts/remove-html-builders.mjs
 * 删除 level-editor.js 中已迁移到 editor/html-builders.js 的函数定义。
 */
import fs from 'fs';
...
const TARGETS = new Set(['fieldHtml', 'selectHtml', 'boardLayerFieldHtml', 'markerHtml', 'lcbSection', 'themeColorInput', 'sortCells']);
